...
export class TemporalByDayComponent extends PlaysViewComponent<Result> {
  ...
  public styles: Record<number, (string | undefined)[]> = {};
  public totalStyles: (string | undefined)[] = [ undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined ];

  constructor(loginService: LoginService) {
    super();
    loginService.registerFeature("temporalbyday");
  }
