...
import {ButtonGroupButtonDirective, ButtonGroupComponent, DataViewComponent} from "extstats-angular";
...
export class RatingOfPlayedComponent extends DataViewComponent<Result> implements OnInit {
  ...
  private data: PlaysData | undefined;
  ...
  constructor(loginService: LoginService) {
    super();
    loginService.registerFeature("ratingofplayed");
  }
  ...
  protected processData(d: Result): void {
    console.log(`rating ${!!d} ${!!(d && d.plays)} ${!!(d && d.plays && d.plays.games)} ${!!(d && d.plays && d.plays.plays)}`);
    console.log(d.plays);
    this.data = d.plays;
