...
import {
  ButtonGroupButtonDirective, ButtonGroupComponent,
...
export class PlaysByMonthYtdComponent extends PlaysViewComponent<PlayAndGamesIndex> {
  public columns: Column<Row>[] = [
    new Column({ field: "month", name: "Month", tooltip: "The month this row is for.", classname: "col-year" }),
    new Column({ field: "plays", name: "Plays", tooltip: "How many games you played in this month.", classname: "col-number"  }),
    new Column({ field: "distinct", name: "Distinct Games", tooltip: "Different games played this month.", classname: "col-number",
      valueTooltip: (r: Row) => r.gamesPlayedNames.join(", ") }),
    new Column({ field: "expansions", name: "Expansions", tooltip: "Different expansions played this month.", classname: "col-number",
      valueTooltip: (r: Row) => r.expansionNames.join(", ") }),
    new Column({ field: "newNickels", name: "New Nickels", tooltip: "Games played 5 times this year due to plays in this month.", classname: "col-number",
      valueTooltip: (r: Row) => r.newNickelNames.join(", ") }),
    new Column({ field: "newDimes", name: "New Dimes", tooltip: "Games played 10 times this year due to plays in this month.", classname: "col-number",
      valueTooltip: (r: Row) => r.newDimeNames.join(", ") }),
    new Column({ field: "newQuarters", name: "New Quarters", tooltip: "Games played 25 times this year due to plays in this month.", classname: "col-number",
      valueTooltip: (r: Row) => r.newQuarterNames.join(", ") }),
    new Column({ field: "newDollars", name: "New Dollars", tooltip: "Games played 100 times this year due to plays in this month.", classname: "col-number",
      valueTooltip: (r: Row) => r.newDollarNames.join(", ") }),
    new Column({ field: "hoursPlayed", name: "Hours Played", classname: "col-number",
      tooltip: "Approximate time it took you to play these games cumulative for the year." }),
