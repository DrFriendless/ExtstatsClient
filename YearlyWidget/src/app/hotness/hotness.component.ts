...
export class YearlyHotnessComponent implements OnChanges {
  ...
  private params: ColumnParams<MostPlayedEntry>[] = [
    ...
    { field: "geeks", name: "Geeks Playing", tooltip: "Distinct players of the game in this year" },
    { field: "plays", name: "Total Plays", tooltip: "Plays by all players in this year" },
    ...
    {
      field: "plays", name: "Your Plays", tooltip: "Your plays of this game",
